...
namespace DX12GameProgramming
{
    ...
    public class D3DApp : IDisposable
    {
        ...
        private bool _showFPS;              // JO: show FPS (allow to turn off)
        ...
        protected bool _appPaused { get; set; }
        ...
        public virtual void InitializeNoFPS()
        {
            InitMainWindow();
            InitDirect3D();
        ...
        public virtual void WShow()
        {
            _window.Show();
        }
        public virtual void WHide()
        {
            _window.Hide();
        }
        ...
        public void Run()
        {
            ...
            while (_running)
            {
                ...
                if (!_appPaused)
                {
                    if(_showFPS) CalculateFrameRateStats();
                    Update(Timer);
                    Draw(Timer);
                }
                else
        ...
        protected virtual void DoWhilePaused(GameTimer gt) { }
